    ...
    <div class="container mx-auto my-5 p-3">
        ...
        <div class="w-full lg:w-2/3 mx-auto md:pt-10">
            <div class="tabulation flex flex-col md:flex-row gap-4 overflow-scroll md:overflow-hidden">
                ...
                <router-link to="/projects/ksre" class="header-tab">Projects</router-link>
                <router-link to="/articles" class="header-tab">Blog</router-link>
                <router-link to="/about" class="header-tab">About</router-link>
            </div>
            <div class="content bg-cream-light border-crayon border-4
                       rounded-b-lg rounded-tr-lg rounded-tl-lg md:rounded-tl-none p-3 mt-5 md:mt-0 overflow-x-visible lg:overflow-x-auto">
...
/* Custom Components */
.header-tab {
    @apply bg-crayon text-cream-vanilla px-3 py-1 rounded-t-lg rounded-b-lg md:rounded-b-none hover:bg-crayon-dark;
}

.router-link-active {
    @apply bg-crayon-dark;
}
