            ...
            <div class="flex flex-col gap-3">
                ...
                <div id="downloads">
                    <div class="download flex flex-row flex-wrap gap-4">
                        ...
                        <a href="https://github.com/fleetingheart/ksre/releases/download/v1.4.2/KSRE-win.zip"
                            class="fhs-button flex flex-row items-center gap-1">
                        ...
                        <a href="https://github.com/fleetingheart/ksre/releases/download/v1.4.2/KSRE-linux.tar.bz2"
                            class="fhs-button flex flex-row items-center gap-1">
                        ...
                        <a href="https://github.com/fleetingheart/ksre/releases/download/v1.4.2/KSRE-mac.zip"
                            class="fhs-button flex flex-row items-center gap-1">
                        ...
                        <a href="https://github.com/fleetingheart/ksre/releases/download/v1.4.2/com.fhs.ksre-release.apk"
                            class="fhs-button flex flex-row items-center gap-1">
                        ...
                        <a href="https://github.com/fleetingheart/ksre/releases/download/v1.4.2/KSRE-ios.ipa"
                            class="fhs-button flex flex-row items-center gap-1">
                ...
                <p class="font-mono font-bold text-lg">Current Version: v1.4.2</p>
