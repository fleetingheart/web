            ...
            <div class="flex flex-col gap-3">
                ...
                <div id="downloads">
                    <div class="download flex flex-row flex-wrap gap-4">
                        <a href="/superbuild/production/KSRE-pc.zip"
                        ...
                        <a href="/superbuild/production/KSRE-android.apk"
                            class="fhs-button flex flex-row items-center gap-1">
                            <svg width="32" height="32" viewBox="0 0 24 24">
                                <path fill="#ffebbe"
                        ...
                        <a href="https://git.envs.net/nickname-ru/katawa-shoujo-re-engineered"
                            class="fhs-button flex flex-row items-center gap-1">
